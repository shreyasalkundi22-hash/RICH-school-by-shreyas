          ...
          <div className="flex items-center gap-2 shrink-0">
            <a href="#home" className="flex items-center gap-2 sm:gap-2.5 group focus:outline-none shrink-0">
              ...
              <div className="flex flex-col justify-center select-none shrink-0">
                <span className="font-cormorant font-bold text-base sm:text-lg lg:text-xl tracking-wider text-brand-dark group-hover:text-brand-green transition-colors leading-none whitespace-nowrap">
                  JR. RICH
                </span>
